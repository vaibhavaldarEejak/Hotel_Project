  ...
  return (
    <>
      ...
      <div className='container'>
        ...
        <div className='col-lg-4 mt-3 p-3 me-3 contact_InfoCard'>
            <span className='d-flex flex-column'>
              <i className="fa fa-envelope pe-2 text-danger fs-4 "></i>
              <span className='text-uppercase pt-3 contactSec_Info'>Email</span>
            </span>
          ...
          <div className='col-lg-3 mt-3 p-3 me-3 contact_InfoCard'>
            <span  className='d-flex flex-column'>
              <i className="fa fa-phone pe-2 text-danger fs-4"></i>
              <span className='text-uppercase pt-3 '>Call us</span>
            </span>
            <h5 className='mt-3'>+919999999</h5>
            <h5>+918888888</h5>
          </div>

          <div className='col-lg-4 mt-3 p-3  contact_InfoCard'>
            <span  className='d-flex flex-column'>
              <i className="fa fa-map-marker pe-2 text-danger fs-4"></i>
              <span className='text-uppercase pt-3'>Location</span>
            </span>
          ...
          <div className='col-sm-12 col-lg-12 mt-5 mb-5'>
            <h1 className='contactSendMessage_heading text-center'>Drop us a Message</h1>
            <form className="row g-3 mt-4 ">
              ...
              <div className="col text-center">
                <button type="submit" className="btn btn-primary mb-3 p-3 fw-bolder text-center border rounded-5 contactSection">Send A Message</button>
              </div>
            </form>
          </div>
