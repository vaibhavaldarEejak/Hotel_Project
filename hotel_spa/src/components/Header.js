                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown ">
                                <Link className="nav-link dropdown-toggle text-dark px-5 text-dark fw-bolder " to="/aboutus" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    About
                                </Link>
                            ...
                            <li className="nav-item dropdown">
                                <Link to='/hotels' className="nav-link dropdown-toggle text-dark px-5 text-dark fw-bolder " id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Hotel
                                </Link>
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><Link to='/hotels' className="dropdown-item">Something else here</Link></li>
